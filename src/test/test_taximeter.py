...
from src.taximeter import Taximeter  # Asegúrate de que la ruta sea correcta

class TestTaximeter(unittest.TestCase):

    def setUp(self):
        self.patcher_fare = patch('src.taximeter.Fare')
        self.patcher_ride = patch('src.taximeter.Ride')
